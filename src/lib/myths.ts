...
const RAW = [
  {
    ...
    name: "Persephone",
    tradition: "Greek",
    origin: "Eleusinian / Greek",
    short:
      "A daughter eats six seeds in the underworld and learns that return is never a full return. Half the year she is queen below; half the year the world remembers how to bloom.",
    full: "Kore is gathering flowers when the ground opens. Hades takes her below. Demeter, refusing to let the world go on as if nothing happened, starves the fields until a bargain is struck. Persephone will rise, but she has eaten the pomegranate. The seeds are not a trick so much as a fact: what you take in the dark becomes part of you. She does not come back as the girl who left. She comes back as someone who can walk both worlds, and the seasons learn to breathe around that split.\n\nThe Eleusinian rites treated this not as a kidnapping anecdote but as the secret of grain: life is cyclic, and the underworld is not the opposite of life. It is the cellar where life is stored.",
    psychology:
      "When Persephone arrives, a life is often in a necessary winter. Not punishment: initiation. The work is not to claw back to an earlier self, but to notice what you ingested while you were down there, and what you are now queen of.",
    reflection: "What did you eat in the dark that you cannot un-eat, and how is it trying to feed you now?",
    weights: { descent: 3, return: 2, sovereignty: 1, shadow: 1 },
    questions: [
      "What season of yourself are you refusing to name as a season?",
      "If the underworld asked you to keep one thing and leave the rest, what would you keep?",
      "Where in your life is return possible, and where would return be a lie?",
    ],
    sigil: "seed",
  },
  {
    ...
    questions: [
      "What lamp are you refusing to lift, and what would you owe yourself if you did?",
      "Which impossible task in your life is actually soul-making in disguise?",
      "Can you love a person, or a calling, with the light on?",
      "If life is both a game and a myth, which structure are you using to avoid the other?",
    ],
    sigil: "moth",
  },
  {
  ...
  },
  {
    ...
    weights: { craft: 2, eros: 1, shadow: 1, sovereignty: 2, threshold: 1 },
    questions: [
      "Where in your life are you the map and never the traveler?",
      "What did you hand over that you now need back?",
      "If no one needed you to be useful, what would you become?",
    ],
    sigil: "thread",
  },
  {
    ...
    name: "Orpheus",
    tradition: "Greek",
    origin: "Greek / Thracian",
    short:
      "A musician charms death itself, then turns around too soon. The myth is not about failure. It is about the glance that cannot trust what it cannot see.",
    full: "Eurydice dies. Orpheus descends with a lyre instead of a sword and the underworld weeps. He is granted the impossible: she may follow, if he does not look back until they reach the light. He looks. She is gone a second time, which is worse than the first.\n\nLater versions tear him apart; his head keeps singing. The glance is the whole teaching. Love that cannot bear uncertainty will sabotage its own miracle. Campbell would call it a failed return. Von Franz would say the anima cannot be dragged; she must arrive.",
    psychology:
      "Orpheus is the artist-self who can move the world and still not endure the last stretch of not-knowing. The look back is anxiety wearing the mask of love.",
    reflection: "What are you checking on too soon, and what would happen if you walked a little farther without proof?",
    weights: { eros: 2, descent: 2, shadow: 1, return: 1 },
    questions: [
      "Where is your glance stealing a future that needed a little more dark?",
      "What song of yours still works even after the loss?",
      "Can you love something you cannot supervise?",
    ],
    sigil: "bird",
  },
  {
    ...
    weights: { craft: 2, sovereignty: 1, devotion: 2, shadow: 1 },
    questions: [
      "Which of your gifts is actually a theft from a smaller life you were told to live?",
      "Where are you confusing necessary sacrifice with a habit of being consumed?",
      "If the eagle came tomorrow, would you still call the fire worth it?",
    ],
    sigil: "flame",
  },
  {
    ...
    origin: "Greek",
    short:
      "Born from the head of Zeus already armed, she is strategy without frenzy. She sponsors the city, the craft, the just war, and the cool mind in a hot room.",
    full: "Athena does not arrive as a child. She arrives as a completed thought: gray-eyed, armored, patron of weavers and of the kind of battle that has a purpose. She stands with Odysseus because she loves metis. She stands with the city because chaos is not freedom. In Aeschylus she founds a court so that the Furies can be housed rather than denied.\n\nShe is not warmth. She is the intelligence that keeps warmth from burning the house down.",
    psychology:
      "Athena is the function that can think in the middle of feeling. When she appears, a life needs strategy, craft, and a container for rage that does not shame the rage. Beware the freeze that pretends to be wisdom.",
    reflection: "Where do you need a cooler mind, and where has coolness become a hiding place?",
    weights: { craft: 2, sovereignty: 2, threshold: 1 },
    questions: [
      "What decision have you been trying to feel your way through that actually wants a strategy?",
      "Which of your armors is still useful, and which is leftover from a war that ended?",
      "What fury in you needs a court, not an exile?",
    ],
    sigil: "owl" as Myth["sigil"],
  },
  {
    id: "dionysus",
    name: "Dionysus",
    ...
    questions: [
      "Where has order become a kind of death?",
      "What would a sacred undoing look like, as opposed to a binge?",
      "Which mask is still a tool, and which has grown onto the face?",
    ],
    sigil: "mask",
  },
  {
    ...
    weights: { craft: 2, descent: 2, sovereignty: 1, quest: 1 },
    questions: [
      "Which eye are you being asked to give up: comfort, certainty, reputation?",
      "What knowledge have you already paid for and still refuse to use?",
      "If the ending is not yours to prevent, what is still yours to prepare?",
    ],
    sigil: "bone",
  },
  {
    ...
    weights: { eros: 3, sovereignty: 1, quest: 1, craft: 1 },
    questions: [
      "What would you seek if longing were allowed to be intelligent?",
      "Where have you been asked to split tenderness from power?",
      "Which of your tears is gold, evidence of value, and which is a tax you no longer owe?",
    ],
    sigil: "cup",
  },
  {
    ...
    questions: [
      "Where are you the glitch in a room that needs one, and where are you the glitch because you cannot bear to belong?",
      "What shape have you taken to survive that you no longer need?",
      "If you stopped making trouble, what quieter trouble would you have to feel?",
    ],
    sigil: "mask",
  },
  {
    ...
    weights: { quest: 2, shadow: 2, sovereignty: 1, craft: 1 },
    questions: [
      "Which dragon in your life was once a person, including you?",
      "What gold are you guarding that costs more than it gives?",
      "Whose warning have you understood and still not heeded?",
    ],
    sigil: "serpent",
  },
  {
    ...
    weights: { devotion: 3, craft: 1, descent: 1, eros: 1 },
    questions: [
      "Which piece of yourself have you declared lost that is only missing?",
      "Where are you being asked to invent what cannot be found?",
      "What would reconstitution look like, as opposed to a replica of the old life?",
    ],
    sigil: "moon",
  },
  {
    ...
    origin: "Egyptian",
    short:
      "A green king is killed, dismembered, and becomes the lord of the dead and of grain. Death, in this telling, is a change of office.",
    full: "Osiris teaches the arts of civilization and is murdered by his brother Set. His resurrection is not a return to the old throne. He becomes sovereign of Duat, the inner world, while Horus takes the living crown. Grain is his body: cut, buried, risen.\n\nThe myth refuses the idea that the true king is only the one you can see in daylight. Something essential continues underground, judging, feeding.",
    psychology:
      "Osiris is the self that must change rooms rather than be restored. Depression, exile, a career death: the temptation is to demand the old palace. The deeper invitation is to take up the other sovereignty: the one that feeds from below.",
    reflection: "What in you is finished as a daytime king and not yet sworn in as a nighttime one?",
    weights: { descent: 3, sovereignty: 2, return: 1 },
    questions: [
      "What life is over, even if you are still sitting in its chair?",
      "Where could a death of role become a change of office?",
      "What are you still trying to resurrect that wants to become compost?",
    ],
    sigil: "seed",
  },
  {
  ...
  },
  {
    ...
    questions: [
      "What story of yours is still locked in a sky you have not bargained with?",
      "Where are you small enough to win, and where are you only hiding?",
      "If the treasure is the right to tell, what are you still paying force for?",
    ],
    sigil: "thread",
  },
  {
    ...
    weights: { quest: 3, return: 2, sovereignty: 2, shadow: 1 },
    questions: [
      "What delay have you mistaken for a verdict?",
      "Who laughed early, and what would standing in front of them cost you now?",
      "If the boon is a people, not a trophy, what are you actually trying to found?",
    ],
    sigil: "mountain",
  },
  {
    ...
    questions: [
      "Where are you still waiting to be taught by a room that should be meeting you as an equal?",
      "What would you take home if the visit were allowed to change the map?",
      "Which of your tests have you swallowed to keep the table pleasant?",
    ],
    sigil: "scale",
  },
  {
    id: "chameleon",
    name: "The late messenger",
    tradition: "African",
    ...
    questions: [
      "What true word of yours is moving at chameleon speed, and who is running ahead of it?",
      "If death entered as a timing error, what timing error are you still treating as a law?",
      "Which first report have you built a whole cosmology on?",
    ],
    sigil: "moon",
  },
  {
    ...
    name: "Amaterasu",
    tradition: "Japanese",
    origin: "Shinto / Japanese",
    short:
      "The sun goddess withdraws into a cave and the world goes dark. The other kami dance, laugh, and hold up a mirror until she is curious enough to return.",
    full: "After a conflict with her storm-brother, Amaterasu seals herself in the rock cave Ama-no-Iwato. Crops fail. The kami gather. Uzume dances an outrageous dance; the laughter is so loud that Amaterasu cracks the door. She sees her own brilliance in a mirror and steps out. A rope is stretched so the cave cannot close the same way again.\n\nThe light does not return because it is scolded. It returns because the world becomes interesting.",
    psychology:
      "Amaterasu is depression as withdrawal of the solar self: not laziness, a protest. The medicine in the myth is not force. It is community, humor, and a mirror that does not shame. You cannot drag the sun. You can become a reason for it to look.",
    reflection: "What cave did you enter, and what would make the mouth of it interesting again?",
    weights: { return: 3, descent: 2, threshold: 1 },
    questions: [
      "What light in you went underground as a form of self-protection?",
      "Who is dancing outside your cave without demanding that you perform?",
      "If you saw your own brilliance without flinching, what would you have to do next?",
    ],
    sigil: "star",
  },
  {
    ...
    short:
      "A child is born from a peach and sets out to face demons with a millet dumpling and three animal companions. The hero is not solitary. He is a picnic that learned how to travel.",
    full: "An old couple finds a giant peach; a boy steps out. When he is grown he goes to Onigashima, the island of oni. Along the way he shares food with a dog, a monkey, and a pheasant, and they become his. The demons are defeated not by a lone sword but by a small, well-fed fellowship.\n\nVon Franz would read the animals as instinctual allies. The dumpling is the unglamorous resource: enough, shared.",
    psychology:
      "Momotarō appears when a task is too large for the solo hero myth you were handed. The peach is an unusual origin; the lesson is ordinary: pack food, make friends with your instincts, go.",
    reflection: "Who are your three companions, and have you fed them?",
    weights: { quest: 2, devotion: 2, craft: 1 },
    questions: [
      "What island of trouble are you still approaching as if you had to be the only one?",
      "Which instinct (loyal, clever, far-seeing) have you left hungry?",
      "What ordinary provision (the dumpling) is your actual magic?",
    ],
    sigil: "seed",
  },
  {
    id: "weaver",
    name: "The Weaver and the Cowherd",
    tradition: "Chinese",
    origin: "Chinese (Qixi)",
    short:
    ...
    questions: [
      ...
      "What would it mean to keep a yearly (or weekly) bridge instead of burning the river?",
      "Which work of yours is sacred enough that love must learn to share the sky with it?",
    ],
    sigil: "bridge",
  },
  {
    ...
    origin: "Chinese",
    short:
      "A creator mends a broken sky with five-colored stones and uses the legs of a great turtle as pillars. Repair is a cosmic art.",
    full: "After a catastrophe: a fight of powers that cracks heaven: the sky leaks and the world floods with fire and water. Nüwa smelts colored stones to patch the hole and steadies the four directions. Humans, in some tellings, she has already made from yellow earth, laboriously by hand, then by dragging a cord through clay when the work grew too large.\n\nShe is the patron of the unglamorous miracle: things can be broken and still be lived in, if someone will do the mending.",
    psychology:
      "Nüwa is the psyche in repair mode. Not the original innocence, the patched sky. Perfectionism hates her because the mend will show. Soul prefers her because the world is habitable again.",
    reflection: "What sky of yours is cracked, and what five-colored stone are you refusing to smelt?",
    weights: { craft: 3, devotion: 1, return: 1, sovereignty: 1 },
    questions: [
      "Where are you waiting for an unbroken world instead of becoming the one who patches this one?",
      "What would a visible mend look like in your life: honest, not hidden?",
      "Which of your creations was made by hand, and which by the cord of haste?",
    ],
    sigil: "mountain",
  },
  {
    ...
    weights: { eros: 2, craft: 2, shadow: 1, threshold: 1 },
    questions: [
      "Which gift of yours is made of your own feathers?",
      "Where has curiosity become a way of not trusting?",
      "What room in your life needs a closed door to remain alive?",
    ],
    sigil: "bird",
  },
  {
    ...
    questions: [
      "Whose reputation are you protecting at the cost of your own ground?",
      "Where is endurance still sacred, and where has it become a habit of being tested?",
      "What would it mean to return to the earth that knows you, even if a kingdom wanted a performance?",
    ],
    sigil: "flame",
  },
  {
    ...
    name: "Arjuna",
    tradition: "Hindu",
    origin: "Hindu epic (Mahābhārata / Bhagavad Gītā)",
    short:
    ...
    questions: [
      "Where are you frozen between two armies that both look like family?",
      "What would right action be if it were not about winning the old war?",
      "Who is the charioteer in you, and have you let them speak?",
    ],
    sigil: "blade",
  },
  {
  ...
  },
  {
    ...
    reflection: "What strength did you forget, and who is trying to remind you?",
    weights: { devotion: 3, quest: 2, craft: 1 },
    questions: [
      "Where are you still living under a curse of smallness that has already expired?",
      "What sea would you cross if you remembered your size?",
      "If your chest were opened, what name would be written there, and is it still the right one?",
    ],
    sigil: "mountain",
  },
  {
    ...
    weights: { eros: 2, devotion: 2, craft: 1, descent: 1, sovereignty: 1 },
    questions: [
      "Where have you been wailing when a precise sentence was needed?",
      "What fate did you marry with your eyes open, and how will you walk beside it?",
      "Which boon are you actually asking for, beneath the ones you think you are allowed?",
    ],
    sigil: "thread",
  },
  {
    ...
    name: "Quetzalcōātl",
    tradition: "Aztec",
    origin: "Mesoamerican (Nahua)",
    short:
      "The feathered serpent, culture-bringer, who gives maize and writing and then falls to a shame that sends him east. A god who knows disgrace.",
    full: "Quetzalcōātl is wind, dawn, priest-king of a golden Tollan in the stories. He refuses human sacrifice in some tellings; his rival Tezcatlipoca tricks him into drunkenness and a broken vow. He leaves, burning or sailing east, promising a kind of return. He is also the one who descends to bone-land to retrieve the ingredients of a new humanity, bleeding on the bones to quicken them.\n\nA living set of cultures still holds these figures. Here they are offered as public, widely told patterns: a civilizing gift, a shame, an eastward departure, a possible dawn.",
    psychology:
      "Quetzalcōātl is the high ideal that cannot survive a single night of being merely human: unless it learns to. Shame that ends a vocation is the shadow of purity. The descent for bones is the better myth: new people are made from what was buried, plus a drop of your own blood.",
    reflection: "What gift of yours went into exile because you could not bear a stain?",
    weights: { craft: 2, descent: 1, shadow: 2, return: 1, sovereignty: 1 },
    questions: [
      "Where has purity become the enemy of your continuing?",
      "What bones are you being asked to retrieve from the underworld of your own past?",
      "If you sailed east, what dawn would you actually be seeking?",
    ],
    sigil: "serpent",
  },
  {
    ...
    weights: { craft: 2, eros: 1, descent: 1, return: 1, threshold: 1 },
    questions: [
      "Where are you trying to be a full moon on a new-moon day?",
      "What is being born through you that you keep treating as an inconvenience?",
      "Which of your floods is a destruction, and which is a washing of the loom?",
    ],
    sigil: "moon",
  },
  {
    ...
    weights: { craft: 3, devotion: 1, threshold: 1, eros: 1 },
    questions: [
      "What is in the forge, what is in the poem, and what is in the well, and which did you abandon?",
      "Where do you need heat under control rather than more heat?",
      "What small seasonal stirring (Imbolc in you) are you dismissing because it is not yet spring?",
    ],
    sigil: "flame",
  },
  {
    ...
    questions: [
      "Whose salmon were you cooking when your own life changed?",
      "What small burn is trying to become a way of knowing?",
      "If you already know, what are you still pretending to be a student of?",
    ],
    sigil: "well",
  },
  {
    ...
    questions: [
      ...
      "What betrayal of yours was also a first attempt at having a preference?",
      "If you are the owl now, what can you see that the garden could not?",
    ],
    sigil: "bird",
  },
  {
    ...
    weights: { quest: 2, sovereignty: 1, shadow: 2, devotion: 1 },
    questions: [
      "Which geis of yours is a sacred limit, and which is a superstition?",
      "Where do you need a vat of cold water more than another victory?",
      "What would it mean to stand down without being tied to the stone?",
    ],
    sigil: "blade",
  },
  {
    ...
    questions: [
      "What would you have to take off to enter the next room of your life?",
      "Who failed to mourn you, including you, and what does that failure ask?",
      "If you are back from below, what new authority are you refusing to exercise?",
    ],
    sigil: "aperture",
  },
  {
    ...
    questions: [
      "Who was your Enkidu, the equal, and what did their absence send you hunting?",
      "What plant of exemption are you still clutching?",
      "If you looked at the walls of your actual life, what would count as enough?",
    ],
  ...
  },
  {
    ...
    weights: { trickster: 3, threshold: 1, craft: 1, return: 1 },
    questions: [
      "What are you waiting to be given that you may have to steal from a too-small room?",
      "Where has your hunger been more honest than your virtue?",
  ...
  },
  {
    ...
    origin: "Inuit",
    short:
      "A girl is thrown from a boat; her fingers, cut as she clings, become the creatures of the sea. She is the mother of the animals, and hunters must keep her hair.",
    full: "Tellings differ among Inuit peoples, and the story is not a toy. In a widely shared public version, Sedna is betrayed: by a husband who is not what he seemed, by a father in a storm, and as she grips the kayak her fingers are chopped. They fall into the water and become seals, whales, the food of the people. She sinks and becomes a being whose tangled hair, if neglected, withholds the animals.\n\nShamans in traditional practice go down to comb her. Relationship with the source of life requires tending, not only taking.",
    psychology:
      "Sedna is the wound that became a world. What was cut from you may now be feeding others. The tangled hair is neglected grief. You cannot bully the sea mother. You can go down, gently, and comb.",
    reflection: "What was cut from you that became, against all justice, a source?",
    weights: { descent: 3, shadow: 2, devotion: 1, sovereignty: 1 },
    questions: [
      "Whose hair, including yours: has gone uncombed while everyone waited for food?",
      "What betrayal are you still calling the weather?",
      "If the creatures of your life come from a wound, how will you honor the wound without worshipping the knife?",
    ],
    sigil: "bone",
  },
  {
...
export function getMyth(id: string) {
  return MYTH_BY_ID[id];
}
