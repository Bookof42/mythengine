...
export const PSYCHE_STATIONS: PsycheBeat[] = [
  {
    ...
    scene: {
      ...
      choices: [
        {
          id: "receive",
          label: "I receive the palace without asking its name",
          after: "The rooms keep arriving. Wonder is a kind of consent.",
          weights: { eros: 2, devotion: 1, threshold: 1 },
        },
        {
          id: "inventory",
          label: "I walk the rooms and count what is mine",
        ...
        {
          id: "ask",
          label: "I ask, in the dark, who you are",
  ...
  },
  {
    ...
    scene: {
      id: "psyche-prohibition",
      title: "Do not look",
      body: "A rule arrives the way weather does: already true before you were briefed. You may have everything except his face. Love, for now, is a voice and a weight on the sheets. The lamp is in the room. It has not yet become a plot.",
      art: "/art/scene-door.jpg",
      choices: [
        {
          id: "keep",
          label: "I keep the dark as a vow",
          after: "Some knowledge is a later room. You stay in this one on purpose.",
          weights: { devotion: 3, eros: 1 },
        },
        {
          id: "test",
          label: "I test the edge of the rule with a question",
        ...
        {
          id: "resent",
          label: "I resent being loved where I cannot see",
  ...
  },
  {
    ...
    scene: {
      ...
      choices: [
        ...
        {
          id: "almost",
          label: "I light it, then set it down unlifted",
        ...
        {
          id: "refuse",
          label: "I refuse the old voices and keep the dark",
  ...
  },
  {
    ...
    scene: {
      ...
      choices: [
        {
          id: "begin",
          label: "I begin the work I cannot finish alone",
        ...
        {
          id: "bargain",
          label: "I try to bargain the tasks down to something reasonable",
        ...
        {
          id: "refuse-task",
          label: "I refuse to be trained by the one who hates me",
  ...
  },
  {
    ...
    scene: {
      ...
      choices: [
        ...
        {
          id: "open",
          label: "I open it: I have come too far not to look",
        ...
        {
          id: "empty",
          label: "I go down with nothing extra, not even the errand",
  ...
  },
  {
    ...
    scene: {
      ...
      body: "The marriage that follows is not the palace restored. It is the same love, conscious. Wings, in the old telling, because soul has done the work of becoming visible to itself. You do not get the system explained. You get a life you can inhabit in daylight.",
      art: "/art/threshold.jpg",
      choices: [
        {
          id: "stay",
          label: "I stay, and let the looking be mutual",
          after: "Return is not rewind. It is the same world, newly able to bear a face.",
          weights: { return: 3, eros: 2, devotion: 1 },
        },
        {
          id: "teach",
          label: "I keep the tasks as a craft I can offer",
          after: "The seeds, the wool, the jar: curriculum. Someone else is still in the dark palace.",
          weights: { craft: 2, devotion: 2, return: 1 },
        },
        {
          id: "stars",
          label: "I look up: the story was always larger than the marriage",
...
export function buildPsycheSequence() {
  ...
  for (const station of PSYCHE_STATIONS) {
